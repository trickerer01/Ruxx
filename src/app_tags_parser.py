...
re_plains = {
    ...
    ProcModule.PROC_EN: re_compile(fr'^-?{TAG_CHAR}+?$'),
}
re_metas = {
    ...
    ProcModule.PROC_EN: re_compile(fr'^{META_CHAR}+?{META_COUNT_EN}$'),
}
re_sorts = {
    ...
    ProcModule.PROC_EN: re_compile(fr'^{META_SORT_EN}$'),
}
re_favs = {
    ...
    ProcModule.PROC_EN: re_compile(fr'^{META_FAV_EN}$'),
}
re_pools = {
    ...
    ProcModule.PROC_EN: re_compile(fr'^{META_POOL_EN}$'),
}
re_orgrs_full = {
    ...
    ProcModule.PROC_EN: re_compile(fr'^\((?:{RE_ORGR_PART_EN})(?:~{RE_ORGR_PART_EN})+?\)$'),
}
re_orgrs_full_s = {
    ProcModule.PROC_RX: re_compile(fr'^\( (?:{RE_ORGR_PART_RX})(?: ~ {RE_ORGR_PART_RX})+? \)$'),
    ProcModule.PROC_RN: re_compile(fr'^\( (?:{RE_ORGR_PART_RN})(?: ~ {RE_ORGR_PART_RN})+? \)$'),
