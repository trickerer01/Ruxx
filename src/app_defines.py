...
SITENAME_B_RZ = 'aHR0cHM6Ly9ydWxlMzQueHl6Lw=='
...
MESSAGE_EMPTY_SEARCH_RESULT_RZ = MESSAGE_EMPTY_SEARCH_RESULT_RX
MESSAGE_EMPTY_SEARCH_RESULT_RP = MESSAGE_EMPTY_SEARCH_RESULT_RN
...
FILE_NAME_PREFIX_RZ = f'{MODULE_ABBR_RZ}_'
...
ID_VALUE_SEPARATOR_CHAR_RZ = ':'
ID_VALUE_SEPARATOR_CHAR_RP = '='
MODULE_CHOICES = (MODULE_ABBR_RX, MODULE_ABBR_RN, MODULE_ABBR_RS, MODULE_ABBR_RZ, MODULE_ABBR_RP)
...
TAG_LENGTH_MAX_RS = 9
TAG_LENGTH_MAX_RZ = 9
TAGS_STRING_LENGTH_MAX_RX = 3300  # '4000 after all special symbols converted' longer tags string will always return empty result
