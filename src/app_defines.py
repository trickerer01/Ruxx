...
MODULE_ABBR_RP = 'rp'
MODULE_ABBR_EN = 'en'
MODULE_ABBRU_RX = MODULE_ABBR_RX.upper()
MODULE_ABBRU_RN = MODULE_ABBR_RN.upper()
MODULE_ABBRU_RS = MODULE_ABBR_RS.upper()
MODULE_ABBRU_RZ = MODULE_ABBR_RZ.upper()
MODULE_ABBRU_RP = MODULE_ABBR_RP.upper()
MODULE_ABBRU_EN = MODULE_ABBR_EN.upper()
...
MODULE_CHOICES = (MODULE_ABBR_RX, MODULE_ABBR_RN, MODULE_ABBR_RS, MODULE_ABBR_RZ, MODULE_ABBR_RP, MODULE_ABBR_EN)
