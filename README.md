...
- The syntax is same for all modules, don't use curvy brackets for RS
...
### Technical info
Ruxx is written is Python (3.7). Lines of code: 9100+. Executables built using PyInstaller (5.8 for Windows, 3.6 for Linux)
